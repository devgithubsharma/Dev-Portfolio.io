  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
      <form method='POST' action='https://getform.io/f/6e25d0a6-daff-4de9-bd4b-dd1a4f6cc107' className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-2'>
            <p className='text-2xl font-bold inline border-b-4 border-rose-600 text-gray-100'> Contact</p>
            <p className='text-gray-100 py-2'>Interested to Know more ? <br/> Contact me on - devsharmabsr03@gmail.com</p>
        </div>
        ...
        <button className='text-white border-2 hover:bg-pink-600 hover:border-pink-600 px-4 my-8 mx-auto flex items-center '>
            Let's Collaborate
        </button>   
      </form>
    </div>
