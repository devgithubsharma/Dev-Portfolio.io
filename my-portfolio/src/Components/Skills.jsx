  ...
  return (
    <div name='skills' className='w-full h-screen bg-[#0a192f] text-gray-300'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        <div>
            <p className='text-3xl font-bold inline border-b-4 border-rose-600'>Skills</p>
            <p className='py-3 text-2xl'>These are the Technology stacks, I've worked with !</p>
        </div>

        <div className='w-full grid grid-cols-3 sm:grid-cols-4 gap-2 text-center py-8'>
